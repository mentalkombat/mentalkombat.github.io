...
class SpellWindow {
	...
	isMouseOnWheel() {
		...
		that.context.canvas.addEventListener('mousemove', function(event){
			...
			if(mouse.x - 760 <= that.wheelRadius && mouse.x - 760 > - that.wheelRadius && mouse.y - 380 <= that.wheelRadius  && mouse.y - 380 > - that.wheelRadius){		
				that.stopWheel();
			} else {
